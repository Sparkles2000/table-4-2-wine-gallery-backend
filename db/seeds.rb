...
w20 = Winepurchase.create!(purchasepackage: 'VIP Diamond Premium', ordered: "Any session, Krug one other wine, two hors d'oeuvres.", customergroup_id: c5.id, brandofwine_id: b9.id)
w21 = Winepurchase.create!(purchasepackage: 'VIP Diamond Premium', ordered: "Any session, Krug one other wine, two hors d'oeuvres.", customergroup_id: c5.id, brandofwine_id: b16.id)
w22 = Winepurchase.create!(purchasepackage: 'VIP Diamond Premium', ordered: "Any session, Krug one other wine, two hors d'oeuvres.", customergroup_id: c5.id, brandofwine_id: b18.id)
w23 = Winepurchase.create!(purchasepackage: 'Five High Premium', ordered: "Five High Session, four wines $15 and below, three hors d'oeuvres.", customergroup_id: c7.id, brandofwine_id: b5.id)
w24 = Winepurchase.create!(purchasepackage: 'Five High Premium', ordered: "Five High Session, four wines $15 and below, three hors d'oeuvres.", customergroup_id: c7.id, brandofwine_id: b19.id)
w25 = Winepurchase.create!(purchasepackage: 'Five High Premium', ordered: "Five High Session, four wines $15 and below, three hors d'oeuvres.", customergroup_id: c7.id, brandofwine_id: b20.id)
w26 = Winepurchase.create!(purchasepackage: 'Five High Premium', ordered: "Five High Session, four wines $15 and below, three hors d'oeuvres.", customergroup_id: c7.id, brandofwine_id: b24.id)
